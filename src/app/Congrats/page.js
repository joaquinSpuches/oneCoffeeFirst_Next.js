...
export default function page(params) {
    return(
        <div className="h-screen flex flex-col text-white  bg-green-600 justify-around items-center">
            ...
            <Image src="https://firebasestorage.googleapis.com/v0/b/onecoffeefirst-5da09.appspot.com/o/Touch%20ID%20Symbol.png?alt=media&token=5619aa3a-6a48-4752-87ef-4471dac61c2e" width={84} height={86} alt="Compra Exitosa"/>
