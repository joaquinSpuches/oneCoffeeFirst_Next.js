...
export default function CartelAceptar({response}) {
   ...
   useEffect(() => {
    ...
    if (param) {
    return(
        <div className='fixed bg-black bg-opacity-10   z-50 h-screen top-0 w-full '>
           <div className="fixed top-1/2 ">
           <h1 className='text-xl text-center  p-5 font-bold w-screen text-black  '>¿Seguro que quieres realizar la compra? </h1>
